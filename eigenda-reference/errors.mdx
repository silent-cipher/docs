...
Rescan API returns machine readable error codes, human readable error messages and a link to the docs for more information.
...
```json
{
  "status": 400,
  "body": {
    "errors": ["operatorAddress is required."]
  }
}
```
...
Here is a list of all error codes Rescan API returns:
